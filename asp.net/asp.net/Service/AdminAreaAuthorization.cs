...
//        x => x is AreaAttribute && (x as AreaAttribute).RouteValue.Equals(area, StringComparison.OrdinalIgnoreCase))
//        || controller.RouteValues.Any(x => x.Key.Equals("area", StringComparison.OrdinalIgnoreCase)
